                ...
                <div class="card-body">
                    <form action="index.php" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="usuario" id="nome" placeholder="Nome de usuário já existe. Escolha outro." required>
                        </div>
                        <div class="mb-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="index.php" method="post">
                        ...
                        <div class="mb-3">
                            <label for="confirmarSenha" class="form-label">Confirmar Senha</label>
                            <input type="password" class="form-control" id="confirmarSenha" placeholder="Os campos (senha) e (confirma senha) estão com valores diferentes" name="confirmarSenha" required>
                        </div>
                        <button type="submit" class="btn btn-primary" name="submit">Cadastrar</button>
                    </form>
                </div>
